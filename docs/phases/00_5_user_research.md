...
**Duration**: 1.5 weeks (Jun 2026)
**Dependencies**: Phase 0 (bare repo exists)
**Output**: Validated value proposition or pivot decision

---

### Task 0.5.0: Desk Research

- [ ] 0.5.0.1: Competitor teardown — audit existing tools (Perplexity for Science, Elicit, Scite,
...
- [ ] 0.5.0.2: Forum/community analysis — mine r/bioinformatics, r/labrats, r/comp_chem,
...
- [ ] 0.5.0.3: Published surveys review — check existing papers on AI tool adoption in research
      (Nature 2023 tools survey, Wellcome researcher survey, relevant DOIs) for quantitative baselines

### Task 0.5.1: Define Research Protocol
...
- [ ] 0.5.2.1: Identify 10–12 potential participants across all 5 segments
...
- [ ] 0.5.2.4: Target: 4–6 completed interviews (minimum 1 per segment, bonus for overlapping segments)
...
- [ ] 0.5.5.2: Decision criteria:
  - At least 4 out of 6 interviewees rate "local-first scientific AI with provenance" as high priority (4+ on 5-point scale)
  - At least 2 interviewees express willingness to participate in a pilot program
  - No interviewees identify a critical flaw that the roadmap cannot address
- [ ] 0.5.5.3: If all criteria met → proceed to Phase 1
- [ ] 0.5.5.4: If criteria partially met → adjust roadmap scope and re-interview 2-3 more scientists
