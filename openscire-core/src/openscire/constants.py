...
class ErrorCode(StrEnum):
    ...
    REF_AUTH_FAILURE = "REF_AUTH_FAILURE"
    REF_SYNC_ERROR = "REF_SYNC_ERROR"
    REF_IMPORT_ERROR = "REF_IMPORT_ERROR"
    REF_PARSE_ERROR = "REF_PARSE_ERROR"
    REF_NETWORK_ERROR = "REF_NETWORK_ERROR"

    AGENT_BUS_ROUTING = "AGENT_BUS_ROUTING"
    AGENT_DELIVERY_FAILURE = "AGENT_DELIVERY_FAILURE"
    AGENT_INVALID_MESSAGE = "AGENT_INVALID_MESSAGE"
    AGENT_UNKNOWN_RECIPIENT = "AGENT_UNKNOWN_RECIPIENT"
    AGENT_SUPERVISOR = "AGENT_SUPERVISOR"
    AGENT_HEALTH_TIMEOUT = "AGENT_HEALTH_TIMEOUT"
    AGENT_CONFLICT_UNRESOLVED = "AGENT_CONFLICT_UNRESOLVED"
    AGENT_HANDOFF_PENDING = "AGENT_HANDOFF_PENDING"
