...
Purpose: Defines a structured, provenance-aware exception hierarchy with symbolic error codes and source attribution for all openSciRe subsystems.

Status: Stable

Public API:
- `openSciReError` — Base exception for all openSciRe errors
- `ProvenanceError` — Provenance tracking failures (signature mismatch, cycle detection, storage errors)
